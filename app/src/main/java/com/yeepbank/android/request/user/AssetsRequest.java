 ...
 */
public class AssetsRequest extends BaseRequest {
    private String investorId;

    public AssetsRequest(Context context, StringListener stringListener,String userId) {
    ...
    protected String getUrl() {
        return Cst.URL.GET_ACCOUNT_MSG_URL;
    }
